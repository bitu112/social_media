     ...
     if(isset($_GET['u_id'])){
		 ...
		 echo"
		    <div class='row'>
			  ...
			  <img  class='img'src='users/$image' width='150px' height='150px'>
			  <br><br> 
			  <ul class='list-group'>
		 ...
		 if($user_id == $userown_id){
			echo "<a id='edit_profile' href='edit_profile.php?u_id=$userown_id' 
			class='btn btn-succes'>Edit Profile</a><br><br><br>"; 
		 }
		 echo "
		  </div>
		  </div>
	  ...
	  ?>
	  <div id="post-box" class="col-sm-8">
	   <center>
	   <h1>Posts</h1>
	   </center>
	   <?php 
					 ...
					 <div class='col-sm-6'>
					  <h3>
					    <a style='text-decoration:none;cursor:pointer; 
                         color:#3897f0;' href='user_profile.php?u_id=$user_id'>$user_name</a>
					  </h3>
