...
function get_posts(){
	...
	while($row_post = mysqli_fetch_array($run_posts)){
		...
		$content = substr($row_post['post_content'],0,40);
...
function single_post(){
			  ...
			  <div id='posts' class='col-sm-6'>
			    <div class='row'>
				  ...
				  <div class='col-sm-6'>
					...
					color:#3897f0;' href='user_profile.php?u_id=$user_id'>$user_name</a></h3>
					<h4><small style='color:black;'>Updated a post on
					<strong>$upload_image</strong></small></h4>
				  </div>
				  <div class='col-sm-4'>
			...
			if($comment == ""){
			 ...
			 echo "<script>window.open('single.php?post_id=$post_id','_self')</script>";
				...
				$insert = "insert into comments(post_id,user_id,comment,comment_author,date)
				 ...
				 $run = mysqli_query($con,$insert);
				 echo"<script>alert('Your comment edit!')</script>";
				 echo"<script>window.open('single.php?post_id=$post_id','_self')</script>";
			}
			 ...
			 <div class='col-sm-6'>
			   <div class='row' id='find_people'>
			    <div class='col-sm-4'>
				  ...
				  <img class='img-circle' src='users/$user_image' width='80px' height='80px' 
				  title='$username' style='float:left;margin:1px;'/>
				  </a>
				    <a style='text-decoration:none;
					color:#3897f0;' href='user_profile.php?u_id=$user_id'>
 ...
 function user_posts(){
	...
	while($row_posts=mysqli_fetch_array($run_posts)){
	   $post_id = $row_posts['post_id'];
	   $user_id = $row_posts['user_id'];
	   $content = $row_posts['upload_image'];
	   $post_date = $row_posts['post_date'];
 ...
 //function for search : post_content and upload_image name 
 function results(){
	 global $con;
