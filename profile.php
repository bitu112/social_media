...
<div class="row">
  ...
  <div class="col-sm-8">
    <?php  
	 echo"
	   <div>
	     <div><img id='cover-img' class='img-rounded' src='cover/$user_cover'
		 alt='cover'></div>
		 ...
		 <li class='dropdown'>
	      ...
	      <strong>Update Cover</strong></p>
		  <label class='btn btn-info'>Chose Image 
	   ...
	   <div id='profile-img'>
	     <img src='users/$user_image' alt='Profile' class='img-circle' width='170px' height='170px' >
		 <form action='profile.php?u_id='$user_id' method='post' enctype='multipart/form-data' >
		 <label class='btn btn-info' id='update_profile'>Select Profile
		 <input type='file' name='u_image' size='60' />
		 </label><br><br>
		 <button id='button_prof' name='update' class='btn btn-info'>Update Profile</button>
		 </form>	 
	   </div><br>
	 ";
	?>
  ...
  <div class="col-sm-2">
   ...
   <div class="col-sm-2" style="background-color:grey;border-radius:2px;margin-left:20px;">
   <?php
     echo 
	 "<center><h2><strong>About</strong></h2></center>
	 <center><h4><strong>$first_name $last_name</strong></h4></center>
	 <p><strong><i style='color:lightblue;'>$describe_user</i></strong></p><br>
		   ...
		   //now we will display the posts
			if($content == "No" && strlen($upload_image)>=1){
               ...
               <a href='single.php?post_id=$post_id' style='float:right;'><button
                class='btn btn-succes'>View</button></a>
			   ...
			   if($u_email != $user_email){
				   ...
				   echo "
					...
					<button class='btn btn-succes'>View</button></a>
