...
<div class="row">
 <div class="col-sm-12">
  <div  class="well">
     <center><h1 style="color:lightblue;">Social media </h1></center>
  </div>
 </div>
</div>
<div class="row">
	 ...
	 <div class="l-part">
	    <form action="" method="post">
		  ...
		  <div class="overlap-text">
		   ...
		   class="form-control input-md"><br>
		   <a style="text-decoration:none;float:right;color:lightblue;"
		   data-toggle="tooltip" title="Reset Password" href="forgot_password.php"></a>
		  </div>
		  <a style="text-decoration:none; float:right;color:#187FAB;" 
		  data-toggle="tooltip" title="Create account" href="signup.php">Don't have an account?</a><br><br>
